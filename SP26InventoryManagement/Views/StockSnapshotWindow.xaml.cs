...
public partial class StockSnapshotWindow : Window
{
    private readonly CurrentUserContext _currentUserContext;
    private readonly DispatcherTimer _sessionMonitorTimer;
    private bool _isNavigatingToLogin;

    public StockSnapshotWindow(StockSnapshotViewModel viewModel, CurrentUserContext currentUserContext)
    {
        InitializeComponent();
        ViewModel = viewModel;
    ...
    public StockSnapshotViewModel ViewModel { get; }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(
                $"Failed to initialize Stock Snapshot screen.\n\n{ex.Message}",
