...
public partial class StaffWarehouseAssignmentWindow : Window
{
    private readonly CurrentUserContext _currentUserContext;
    private readonly DispatcherTimer _sessionMonitorTimer;
    private bool _isNavigatingToLogin;

    public StaffWarehouseAssignmentWindow(
        StaffWarehouseAssignmentViewModel viewModel,
    ...
    public StaffWarehouseAssignmentViewModel ViewModel { get; }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(
                $"Failed to initialize Staff Warehouse Assignment screen.\n\n{ex.Message}",
