...
public partial class ReceiptManagerWindow : Window
{
    private readonly CurrentUserContext _currentUserContext;
    private readonly DispatcherTimer _sessionMonitorTimer;
    private bool _isNavigatingToLogin;

    public ReceiptManagerWindow(ReceiptManagementViewModel viewModel, CurrentUserContext currentUserContext)
    {
        InitializeComponent();
        ViewModel = viewModel;
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        if (!ViewModel.HasPostReceiptPermission)
        {
            MessageBox.Show(
        ...
        {
            MessageBox.Show(
                $"Failed to initialize Receipt Manager screen.\n\n{ex.Message}",
