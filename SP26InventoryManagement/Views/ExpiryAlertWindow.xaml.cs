...
public partial class ExpiryAlertWindow : Window
{
    ...
    public ExpiryAlertWindow(ExpiryAlertViewModel viewModel, CurrentUserContext currentUserContext)
    {
        InitializeComponent();
        ViewModel = viewModel;
    ...
    public ExpiryAlertViewModel ViewModel { get; }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(
                $"Failed to initialize Expiry Alerts screen.\n\n{ex.Message}",
