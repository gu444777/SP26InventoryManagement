...
public partial class TransferWindow : Window
{
    ...
    public TransferWindow(TransferManagementViewModel viewModel, CurrentUserContext currentUserContext)
    {
        InitializeComponent();
        ViewModel = viewModel;
    ...
    public TransferManagementViewModel ViewModel { get; }

    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        Loaded -= OnLoaded;

        if (!ViewModel.HasTransferPermission)
        {
            MessageBox.Show(
        ...
        {
            MessageBox.Show(
                $"Failed to initialize Transfer screen.\n\n{ex.Message}",
